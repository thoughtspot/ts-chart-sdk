...
describe('ChartProvider', () => {
    ...
    test('renders children correctly', () => {
        ...
        expect(container.firstChild?.textContent).toBe('Test Child');
    });
    ...
    test('emitters and event listeners work as expected', async () => {
    ...
    test('correctly updates chartModel state on events', async () => {
        const TestComponent = () => {
            ...
            return (
                <div>
                    <button onClick={emitRenderStart}>Emit RenderStart</button>
                </div>
            );
        };
