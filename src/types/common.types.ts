...
/**
 * User properties have some extra information about the user such as source, persona, teamId and
 * companyName.
 */
...
/**
 * contains user info type. can contian user guid, user name, user email, user type and user
 * properties.
 */
...
export type SortInfo = {
    ...
    /**
     * Sort-by column id
     * When category is BY_MEASURE, this will be the id of the column to sort by
     *
